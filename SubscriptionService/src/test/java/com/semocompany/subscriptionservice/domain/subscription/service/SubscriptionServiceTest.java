...
class SubscriptionServiceTest {
    ...
    void updateSubscription_withCssSelectors_shouldUpdateSelectors() {
        ...
        ReflectionTestUtils.setField(updateRequest, "keywords", newKeywords);
        ReflectionTestUtils.setField(updateRequest, "postLinkSelector", newPostLinkSelector);
        ReflectionTestUtils.setField(updateRequest, "nextPageSelector", newNextPageSelector);
        ...
        // 엔티티의 update 메서드가 올바른 인자와 함께 호출되었는지 검증 (실제로는 private 필드 변경을 통해 확인)
